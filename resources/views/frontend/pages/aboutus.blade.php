   ...
   <div class="container">
       <div id="content">
               ...
               <div class="history-slider">
                   <div class="history-navigation">
                       <a data-slide-index="0"
                          href="blog_with_2sidebars_type_e.html"
                          class="circle"><span class="auto-center">2003</span></a>
                       <a data-slide-index="1"
                          href="blog_with_2sidebars_type_e.html"
                          class="circle"><span class="auto-center">2004</span></a>
                       <a data-slide-index="2"
                          href="blog_with_2sidebars_type_e.html"
                          class="circle"><span class="auto-center">2005</span></a>
                       <a data-slide-index="3"
                          href="blog_with_2sidebars_type_e.html"
                          class="circle"><span class="auto-center">2007</span></a>
                       <a data-slide-index="4"
                          href="blog_with_2sidebars_type_e.html"
                          class="circle"><span class="auto-center">2009</span></a>
                       <a data-slide-index="5"
                          href="blog_with_2sidebars_type_e.html"
                          class="circle"><span class="auto-center">2011</span></a>
                       <a data-slide-index="6"
                          href="blog_with_2sidebars_type_e.html"
                          class="circle"><span class="auto-center">2014</span></a>
                   </div>
                   ...
                   <div class="history-slides">
                       <div>
                           <div class="row">
                               <div class="col-sm-5">
                                   <img src="{{url('assets/dest/images/history.jpg')}}"
                                        alt="">
                               </div>
                               <div class="col-sm-7">
           ...
           <div class="space20">&nbsp;</div>
           <p class="text-center wow fadeInLeft">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi
               ut aliquip ex ea commodo consequat.<br /> Duis aute irure dolor in reprehenderit in voluptate velit esse
           ...
           <div class="row">
               <div class="col-sm-2 col-sm-push-2">
                   <div class="beta-counter">
                       ...
                       <p class="beta-counter-value timer numbers"
                          data-to="19855"
                          data-speed="2000">19855</p>
           ...
           <div class="row">
               <div class="col-sm-6 wow fadeInLeft">
                   <div class="beta-person media">
                       ...
                       <img class="pull-left"
                            src="{{url('assets/dest/images/person2.jpg')}}"
                            alt="">
               ...
               <div class="col-sm-6 wow fadeInRight">
                   <div class="beta-person media ">
                       ...
                       <img class="pull-left"
                            src="{{url('assets/dest/images/person3.jpg')}}"
                            alt="">
           ...
           <div class="row">
               <div class="col-sm-3">
                   <div class="beta-person beta-person-full">
                       <div class="bets-img-hover">
                           <img src="{{url('assets/dest/images/person1.jpg')}}"
                                alt="">
                       </div>
               ...
               <div class="col-sm-3">
                   <div class="beta-person beta-person-full">
                       <div class="bets-img-hover">
                           <img src="{{url('assets/dest/images/person2.jpg')}}"
                                alt="">
                       </div>
                       <div class="beta-person-body">
                           <h5>Bob Robertson</h5>
               ...
               <div class="col-sm-3">
                   <div class="beta-person beta-person-full">
                       <div class="bets-img-hover">
                           <img src="{{url('assets/dest/images/person3.jpg')}}"
                                alt="">
                       </div>
                       <div class="beta-person-body">
                           <h5>Mike Greenwood</h5>
               ...
               <div class="col-sm-3">
                   <div class="beta-person beta-person-full">
                       <div class="bets-img-hover">
                           <img src="{{url('assets/dest/images/person4.jpg')}}"
                                alt="">
                       </div>
                       <div class="beta-person-body">
                           <h5>David Black</h5>
